...
public class CtrlAlquiler_Editar implements ActionListener {
    ...
    public CtrlAlquiler_Editar(VstAlquiler LV) {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == vista.jbtnBuscarHerramienta) {
            if (vista.jtxtMarcaHerramienta.getText().isEmpty() || vista.jcbxTipo.getSelectedIndex() == 0) {
                Mensajes.M1("Completa los campos.");
            } else {
                String marca = vista.jtxtMarcaHerramienta.getText();
                String tipoH = vista.jcbxTipo.getSelectedItem().toString();
        ...
        if (e.getSource() == vista.btnActualizaTipos) {
            ...
            crudh.MostrarHerramientasEnTablaAlquiler(vista.jtblBusquedaHerramientasAlquiler, null, null);
        }
